...
export const CHARACTERS: Record<ResultKey, CharacterData> = {
  A: {
    ...
    compatible: { key: 'E', name: '療癒放映師', reason: '你們都活在情緒和詩意裡，她只是喜歡有人陪著一起感受。' },
    regular: { key: 'F', name: '情緒縱火犯', reason: '她和你一樣在意情緒，但她的強度和音量可能讓你有點吃不消。' },
  },
  ...
  B: {
    ...
    compatible: { key: 'F', name: '情緒縱火犯', reason: '你們都被強烈情緒驅動，她只是更想把這份燃燒分給別人。' },
    regular: { key: 'E', name: '療癒放映師', reason: '你們都在意情緒，但她的溫柔節奏可能讓你有點坐不住。' },
  },
  ...
  C: {
    ...
    compatible: { key: 'G', name: '線索共謀者', reason: '你們都在追謎題，她只是更喜歡拉個人一起解。' },
    regular: { key: 'E', name: '療癒放映師', reason: '你們步調相近，但她要聊情緒，你要繼續在腦子裡拼圖。' },
  },
  ...
  D: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都追謎、都愛高強度，她只是更喜歡多拉一個人一起瘋。' },
    regular: { key: 'G', name: '線索共謀者', reason: '你們都在追謎，但她需要討論，你只想一個人燒。' },
  },
  ...
  E: {
    ...
    compatible: { key: 'A', name: '深夜燈塔者', reason: '你們都愛情緒和詩意，她只是更喜歡一個人靜靜感受。' },
    regular: { key: 'H', name: '邪典探險家', reason: '她和你一樣熱愛找人一起看，但她的片單可能讓你有點招架不住。' },
  },
  ...
  F: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都愛一起看強烈的東西，你追感受她追怪謎，火力相當。' },
    regular: { key: 'G', name: '線索共謀者', reason: '你們都愛找人一起看，但她太冷靜分析，你太燃，節奏對不上。' },
  },
  ...
  G: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都愛一起追謎，她的節奏更爆炸，剛好補足你的冷靜。' },
    regular: { key: 'A', name: '深夜燈塔者', reason: '你們步調都慢，但她更喜歡獨自感受，少了你想要的討論伴。' },
  },
  ...
  H: {
    ...
    compatible: { key: 'F', name: '情緒縱火犯', reason: '你們都愛一起看強烈的東西，她追感受你追怪謎，彼此點火。' },
    regular: { key: 'E', name: '療癒放映師', reason: '她和你一樣愛找人一起看，但你的片單可能讓她有點吃不消。' },
  },
}
