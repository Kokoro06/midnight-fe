...
export type ResultKey = 'A' | 'B' | 'C' | 'D' | 'E' | 'F' | 'G' | 'H'
...
export const QUESTIONS: QuizQuestion[] = [
  {
    step: 1,
    text: '深夜十二點，世界安靜下來。這個時刻，你比較想要的是——',
    axis: 'solo_social',
    options: [
      { type: 'A', text: '一個人把今天好好沉澱一遍' },
      { type: 'B', text: '身邊有個人在，不用說話也好' },
    ],
    footnote: '＊直覺選就好，不需要想太久。',
  },
  {
    step: 2,
    text: '週末午後，朋友傳訊息：「要不要一起去看電影？」你心裡第一個閃過的念頭是——',
    axis: 'solo_social',
    options: [
      { type: 'A', text: '其實我想自己看，旁邊有人反而分心' },
      { type: 'B', text: '好啊，散場後還能一起聊天' },
    ],
    footnote: '＊直覺選就好，不需要想太久。',
  },
  {
    step: 3,
    text: '當電影散場，燈一盞一盞亮起來。你接下來最想做的事是——',
    axis: 'solo_social',
    options: [
      { type: 'A', text: '一個人走一段路再回家，讓那個感覺再心裡發酵' },
      { type: 'B', text: '找個人聊聊剛剛那部片，不然好像還沒看完' },
    ],
  },
  {
    step: 4,
    text: '戴著耳機走在路上，某一句歌詞突然戳中你。你的反應比較像——',
    axis: 'emotion_mystery',
    options: [
      { type: 'A', text: '不換歌，讓它一直播下去' },
      { type: 'B', text: '停下來，去查查這首歌的創作背景' },
    ],
  },
  {
    step: 5,
    text: '看完一部電影，你脫口說出「這部真好看」。對你來說，「好看」比較接近——',
    axis: 'emotion_mystery',
    options: [
      { type: 'A', text: '有個畫面或一句話一直留下來，說不清楚為什麼' },
      { type: 'B', text: '前面藏的線索最後全部對上，越想越有意思' },
    ],
  },
  {
    step: 6,
    text: '一部電影看完一個禮拜後，最容易留在你腦海裡的，通常是——',
    axis: 'emotion_mystery',
    options: [
      { type: 'A', text: '某個畫面，或一段配樂' },
      { type: 'B', text: '還沒想通的伏筆，或結局到底想說什麼' },
    ],
  },
  {
    step: 7,
    ...
    axis: 'poetic_intense',
    options: [
      { type: 'A', text: '節奏慢慢的，看完不一定記得情節，但記得那個感覺' },
      { type: 'B', text: '張力很滿的，看的時候手心出汗，看完會想找人講' },
    ],
    footnote: '＊最後一題了。',
  },
  {
    step: 8,
    text: '忙完很長的一天，你選一種讓自己回血的方式——',
    axis: 'poetic_intense',
    options: [
      { type: 'A', text: '一個人窩在角落，點一盞燈，世界小小的就好' },
      { type: 'B', text: '把音樂開大，讓心裡的情緒發洩出來' },
    ],
  },
...
// Mapping: solo-emotion-poetic=A, solo-emotion-intense=B, solo-mystery-poetic=C, solo-mystery-intense=D,
//          social-emotion-poetic=E, social-emotion-intense=F, social-mystery-poetic=G, social-mystery-intense=H
export function computeResult(answers: OptionBinary[]): ResultKey {
  ...
  const isSolo = a1 >= 2
  const isEmotion = a2 >= 2
  const isPoetic = a3 >= 1

  const idx = (isSolo ? 0 : 4) + (isEmotion ? 0 : 2) + (isPoetic ? 0 : 1)
  return (['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'] as const)[idx]
}
...
export const CHARACTERS: Record<ResultKey, CharacterData> = {
  A: {
    ...
    compatible: { key: 'E', name: '療癒放映師', reason: '你們都活在情緒和詩意裡，他只是喜歡有人陪著一起感受。' },
    regular: { key: 'F', name: '情緒縱火犯', reason: '他和你一樣在意情緒，但他的強度和音量可能讓你有點吃不消。' },
  },
  ...
  B: {
    ...
    compatible: { key: 'F', name: '情緒縱火犯', reason: '你們都被強烈情緒驅動，他只是更想把這份燃燒分給別人。' },
    regular: { key: 'E', name: '療癒放映師', reason: '你們都在意情緒，但他的溫柔節奏可能讓你有點坐不住。' },
  },
  ...
  C: {
    ...
    compatible: { key: 'G', name: '線索共謀者', reason: '你們都在追謎題，他只是更喜歡拉個人一起解。' },
    regular: { key: 'E', name: '療癒放映師', reason: '你們步調相近，但他要聊情緒，你要繼續在腦子裡拼圖。' },
  },
  ...
  D: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都追謎、都愛高強度，他只是更喜歡多拉一個人一起瘋。' },
    regular: { key: 'G', name: '線索共謀者', reason: '你們都在追謎，但他需要討論，你只想一個人燒。' },
  },
  ...
  E: {
    ...
    compatible: { key: 'A', name: '深夜燈塔者', reason: '你們都愛情緒和詩意，他只是更喜歡一個人靜靜感受。' },
    regular: { key: 'H', name: '邪典探險家', reason: '他和你一樣熱愛找人一起看，但他的片單可能讓你有點招架不住。' },
  },
  ...
  F: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都愛一起看強烈的東西，你追感受他追怪謎，火力相當。' },
    regular: { key: 'G', name: '線索共謀者', reason: '你們都愛找人一起看，但他太冷靜分析，你太燃，節奏對不上。' },
  },
  ...
  G: {
    ...
    compatible: { key: 'H', name: '邪典探險家', reason: '你們都愛一起追謎，他的節奏更爆炸，剛好補足你的冷靜。' },
    regular: { key: 'A', name: '深夜燈塔者', reason: '你們步調都慢，但他更喜歡獨自感受，少了你想要的討論伴。' },
  },
  ...
  H: {
    ...
    compatible: { key: 'F', name: '情緒縱火犯', reason: '你們都愛一起看強烈的東西，他追感受你追怪謎，彼此點火。' },
    regular: { key: 'E', name: '療癒放映師', reason: '他和你一樣愛找人一起看，但你的片單可能讓他有點吃不消。' },
  },
}
