...
export const CHARACTERS: Record<ResultKey, CharacterData> = {
  'solo-emotion-poetic': {
    ...
    tags: ['需要被療癒', '文藝', '想念那時候', '想談戀愛'],
    desc: '適合你的是那種溫柔卻不幼稚的文藝片，從「需要被療癒／文藝／想念那時候」這幾個標籤開始逛，很快就會找到今晚想要的氛圍。',
    compatible: [
  ...
  'solo-emotion-intense': {
    ...
    tags: ['想哭一場', '需要被療癒', '很有壓迫感', '驚悚'],
    desc: '找一部別人看了說「太沉重了」的電影，然後一個人扛著走出來。從「想哭一場／很有壓迫感／驚悚」開始找，你不會失望。',
    compatible: [
  ...
  'solo-mystery-poetic': {
    ...
    tags: ['懸疑', '文藝', '越燒越好', '很有壓迫感'],
    desc: '找一部需要你慢慢消化、看完要再想幾天的電影。從「懸疑／文藝／越燒越好」開始，那裡有很多值得你細細翻找的寶藏。',
    compatible: [
  ...
  'social-emotion-poetic': {
    ...
    desc: '找一部可以和重要的人一起看、看完還要聊很久的電影。從「想談戀愛／需要被療癒／文藝」這幾個標籤開始，很容易挖到今晚你想要的那種溫柔。',
    compatible: [
  ...
  'social-emotion-intense': {
    ...
    tags: ['想哭一場', '想愛又怕受傷', '很有壓迫感', '驚悚'],
    desc: '找一部讓你整個人都燃起來的電影，然後拉著最能接受你情緒強度的人一起看。從「想哭一場／很有壓迫感／驚悚」開始挑，你不會找不到。',
    compatible: [
  ...
  'social-mystery-intense': {
    ...
    desc: '今晚不如選一部你朋友可能會看不下去、但你會愛到不行的怪片。從「想看點怪的／驚悚／這世界很荒謬」標籤點進去，很容易挖到你喜歡的寶。',
    compatible: [
